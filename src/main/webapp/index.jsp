  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-body"><img src="img/CR.jpg" class="img-responsive" width=200 height=200 alt="Image"></div>
    ...
    <div class="col-sm-4"> 
      <div class="panel panel-danger">
        ...
        <div class="panel-body"><img src="img/FT.jpg" class="img-responsive" width=200 height=200 alt="Image"></div>
        <div class="panel-footer"></div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-success">
        ...
        <div class="panel-body"><img src="img/BD.png" class="img-responsive"  width=200 height=200 alt="Image"></div>
        <div class="panel-footer"></div>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-body"><img src="img/BC.png" class="img-responsive" width=200 height=200 alt="Image"></div>
        <div class="panel-footer"></div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <div class="panel-body"><img src="img/VL.png" class="img-responsive" width=200 height=200 alt="Image"></div>
        <div class="panel-footer"></div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <div class="panel-body"><img src="img/TN.png" class="img-responsive" width=200 height=200 alt="Image"></div>
        <div class="panel-footer"></div>
      </div>
    </div>
  </div>
